...
- `RESPONSE_NOT_SERIALIZABLE` / `TARGET_INTERNAL_ERROR` mean the target stayed up. Fix the script (or inspect the internal error) and retry; do not assume the instance is gone.
